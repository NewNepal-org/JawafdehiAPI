...
def migrate_urls_to_list(apps, schema_editor):
    ...
    if to_update:
        DocumentSource.objects.using(db_alias).bulk_update(to_update, ['url'], batch_size=500)
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='url',
            field=models.TextField(blank=True, null=True, help_text='URL to the source (temporary TextField)'),
        ),
