...
class CaseSerializer(serializers.ModelSerializer):
    ...
    key_allegations = serializers.ListField(
        child=serializers.CharField(), help_text="List of key allegation statements", required=False
    )
...
class FeedbackSerializer(serializers.ModelSerializer):
    ...
    feedbackType = serializers.CharField(source="feedback_type", help_text="Type of feedback")
    ...
    submittedAt = serializers.DateTimeField(
        source="submitted_at", read_only=True, help_text="Timestamp when feedback was submitted"
    )
