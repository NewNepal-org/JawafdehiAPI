...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.WARNING("WARNING: This will delete all existing cases and document sources!")
        )
...
<li>Victim and accused privacy</li>
        ...
        media.related_entities.set(
            [get_entity("entity:organization/political_party/national-independent-party")]
        )
