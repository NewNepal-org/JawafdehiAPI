    ...
    def handle(self, *args, **options):  # noqa: ARG002
        ...
        case_permissions = {
            "view": Permission.objects.get_or_create(
                codename="view_case", content_type=case_ct, defaults={"name": "Can view case"}
            )[0],
            "add": Permission.objects.get_or_create(
                codename="add_case", content_type=case_ct, defaults={"name": "Can add case"}
            )[0],
            "change": Permission.objects.get_or_create(
                codename="change_case", content_type=case_ct, defaults={"name": "Can change case"}
            )[0],
            "delete": Permission.objects.get_or_create(
                codename="delete_case", content_type=case_ct, defaults={"name": "Can delete case"}
            )[0],
        }
