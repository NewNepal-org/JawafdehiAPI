...
def test_entity_alleged_in_multiple_published_cases():
    ...
    case1 = Case.objects.create(
        case_id="case-001", state=CaseState.PUBLISHED, title="Case 1", description="Test"
    )
    case1.alleged_entities.add(entity)

    case2 = Case.objects.create(
        case_id="case-002", state=CaseState.PUBLISHED, title="Case 2", description="Test"
    )
...
def test_entity_alleged_in_draft_case_not_included():
    ...
    case = Case.objects.create(
        case_id="case-001", state=CaseState.DRAFT, title="Draft Case", description="Test"
    )
    case.alleged_entities.add(entity)
...
def test_entity_alleged_in_closed_case_not_included():
    ...
    case = Case.objects.create(
        case_id="case-001", state=CaseState.CLOSED, title="Closed Case", description="Test"
    )
    case.alleged_entities.add(entity)
...
def test_entity_related_in_published_case():
    ...
    case = Case.objects.create(
        case_id="case-001", state=CaseState.PUBLISHED, title="Test Case", description="Test"
    )
...
def test_entity_in_multiple_cases_with_different_roles():
    ...
    case3 = Case.objects.create(
        case_id="case-003", state=CaseState.PUBLISHED, title="Case 3", description="Test"
    )
...
def test_entity_with_mix_of_published_and_draft_cases():
    ...
    draft_case = Case.objects.create(
        case_id="case-draft", state=CaseState.DRAFT, title="Draft Case", description="Test"
    )
    draft_case.alleged_entities.add(entity)

    # Closed case
    closed_case = Case.objects.create(
        case_id="case-closed", state=CaseState.CLOSED, title="Closed Case", description="Test"
    )
...
def test_in_review_cases_included_when_feature_flag_enabled(settings):
    ...
    case = Case.objects.create(
        case_id="case-001", state=CaseState.IN_REVIEW, title="In Review Case", description="Test"
    )
    case.alleged_entities.add(entity)
...
def test_entity_list_shows_correct_case_ids():
    ...
    # Alleged case
    case1 = Case.objects.create(
        case_id="case-001", state=CaseState.PUBLISHED, title="Alleged Case", description="Test"
    )
    case1.alleged_entities.add(entity)

    # Related case
    case2 = Case.objects.create(
        case_id="case-002", state=CaseState.PUBLISHED, title="Related Case", description="Test"
    )
    case2.related_entities.add(entity)
