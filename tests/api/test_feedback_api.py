...
class TestFeedbackValidation:
    ...
    def test_missing_required_fields(self, api_client):
        ...
        # Missing subject
        response = api_client.post(
            "/api/feedback/", {"feedbackType": "bug", "description": "Test"}, format="json"
        )
        assert response.status_code == 400
...
class TestFeedbackRateLimiting:
    ...
    def test_rate_limit_allows_five_submissions(self, api_client):
        ...
        data = {"feedbackType": "general", "subject": "Test", "description": "Test description"}
    ...
    def test_rate_limit_blocks_sixth_submission(self, api_client):
        ...
        for _ in range(5):
            api_client.post("/api/feedback/", data, format="json", REMOTE_ADDR="192.168.1.100")
