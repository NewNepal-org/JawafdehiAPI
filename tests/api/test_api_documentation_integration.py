...
class TestAPIDocumentationIntegration:
    ...
    def published_case(self):
        ...
        case = create_case_with_entities(
            ...
            timeline=[
                {"date": "2024-01-15", "title": "Event 1", "description": "Event description"}
            ],
    ...
    def document_source(self, published_case):
        ...
        published_case.evidence = [{"source_id": source.source_id, "description": "Test evidence"}]
        published_case.save()
        return source
    ...
    def test_schema_reflects_actual_source_structure(self, document_source):
        ...
        expected_fields = ["id", "source_id", "title", "description", "url", "related_entities"]
