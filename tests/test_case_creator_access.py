...
def test_creator_automatically_added_to_contributors(contributor_user, case_admin):
    ...
    assert contributor_user in case.contributors.all(), "Creator should be in the contributors list"
...
def test_creator_has_view_permission(contributor_user, case_admin):
    ...
    assert has_permission, "Creator should have view permission for their created case"
...
def test_creator_has_change_permission(contributor_user, case_admin):
    ...
    assert has_permission, "Creator should have change permission for their created case"
...
def test_creator_can_see_case_in_queryset(contributor_user, another_contributor, case_admin):
    ...
    assert case2 not in queryset, "Creator should NOT see other contributors' cases in queryset"

    assert queryset.count() == 1, f"Creator should see exactly 1 case, but saw {queryset.count()}"
