...
class TestUploadWorkflowOutputs:
    ...
    def test_excludes_prd_and_progress_json(self, tmp_path):
        ...
        mock_storage.save.side_effect = lambda name, _fh: (saved_names.append(name) or name)
    ...
    def test_storage_paths_use_prefix_and_case_id(self, tmp_path):
        ...
        assert saved_record["backend_path"].startswith(f"{_WORKFLOW_OUTPUTS_PREFIX}/case-abc123/")
